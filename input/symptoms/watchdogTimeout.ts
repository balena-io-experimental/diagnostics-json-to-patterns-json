...
export default {
	...
	description: `We consider increasing the watchdog timeout to be a workaround, and not really a true fix. In some cases 12min might not be enough if the device is under significant load, especially on some low-powered devices, and in other cases 12min is way longer than we want to wait to restart the engine when issues are encountered.
